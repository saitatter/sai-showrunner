...
equivalence. Pixel parity still requires the reference screenshot catalog and
golden/integration comparison described below.
...
corepack yarn overlay:verify-no-vue
