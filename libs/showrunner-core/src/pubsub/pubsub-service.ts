...
import { isObject } from "showrunner-schema"
...
import { isShowRunner } from "../util/init-mode"

const logger = usePluginLogger("pubsub")

const baseURL = "https://api.ShowRunner.io/"
/**
...
export const PubSubManager = Service(
	class {
		...
		private async connectInternal() {
			...
			const negotiationUrl = isShowRunner() ? "/pubsub/negotiate" : "/pubsub/satellite/negotiate"
