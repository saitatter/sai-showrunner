...
import { ChannelPointReward, TwitchAccount } from "ShowRunner-plugin-twitch-main"
import { OBSBoundsType, OBSConnectionConfig, OBSSourceTransform } from "ShowRunner-plugin-obs-shared"
import { SpellHook } from "ShowRunner-plugin-spellcast-main"
import { OBSConnection } from "ShowRunner-plugin-obs-main"
import fs, { unlink } from "fs/promises"
import fsSync from "fs"
import path from "path"
import { RCONConnectionConfig } from "ShowRunner-plugin-minecraft-shared"
import axios from "axios"
import { tryWyzeLogin } from "ShowRunner-plugin-wyze-main"
...
registerOldActionMigrator("ShowRunner", "automation", {
	plugin: "ShowRunner",
...
registerOldActionMigrator("ShowRunner", "delay", {
	plugin: "time",
	action: "delay",
...
registerOldSettingsMigrator("ShowRunner", {
	plugin: "ShowRunner",
...
async function migrateOldAutomation(oldAutomation: OldAutomation): Promise<Sequence> {
	...
	for (const oldAction of oldAutomation.actions) {
		...
		if (oldAction.plugin == "ShowRunner") {
