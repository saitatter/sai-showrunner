...
import {
	initializeShowRunner,
	finializeShowRunnerSetup,
	loadAutomations,
...
app.whenReady().then(async () => {
	...
	await setupShowRunnerDirectories("user-sat")
	...
	await initializeShowRunnerSatellite()

	await loadPlugins()

	await finializeShowRunnerSatelliteSetup()
})
